...
% bullet body. Each section shows one literal entry as the example — the
% machine gate scans this body as LaTeX source, so do not spell a macro call
% out inside a comment here, and do not wrap the entries in loops.
