...
{"name","title","email","phone","localizedContacts":{"zh-CN":{"email","phone"}},"location","linkedin","github","website","summary","skills":[string],"education":[{"institution","degree","date","location","localized":{"zh-CN":{"institution","degree","date","location"}}}],"experience":[{"company","title","date","location","url","localized":{"zh-CN":{"company","title","date","location"}},"description":[{"text","textZh":null}]}],"projects":[{"name","role","url","demo","technologies","dateRange","localized":{"zh-CN":{"name","role","dateRange"}},"description":[{"text","textZh":null}]}],"customSections":[{"title","entries":[{"heading","subheading","date","description":[{"text","textZh":null}]}]}]}
...
{"skills":[string],"experience":[{"company","title","date","location","url","localized":{"zh-CN":{"company","title","date","location"}},"description":[{"text","textZh":null,"source"}]}],"projects":[{"name","role","technologies","dateRange","url","demo","localized":{"zh-CN":{"name","role","dateRange"}},"description":[{"text","textZh":null,"source"}]}],"education":[{"institution","degree","date","location","localized":{"zh-CN":{"institution","degree","date","location"}}}],"certifications":[{"name","issuer","date"}],"customSections":[{"title","entries":[{"heading","subheading","date","description":[{"text","textZh":null,"source"}]}]}],"notes":string}
Rules:
