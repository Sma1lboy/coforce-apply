...
const BANNER = {
  queueing: 'Boarding…', working: 'Agent is applying — autopilot on',
...
export default function ApplyDialog({ job, mode, agent = 'claude', onClose, onQueued }) {
  ...
  const headlessSteps = [
    ...
    [`${agentName} fills the application (tailor → forms → uploads)`,
            ...
            <div className="p-5">
              ...
              {phase === 'error' ? (
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <Step i={2} state="todo">Paste in your terminal to run the Chrome-backed flow (enable one-click background apply in setup to skip this step)</Step>
